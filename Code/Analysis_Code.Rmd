...
```{r Load Data}
Numerosity_Comparison_Task <- read_csv("./Numerosity_Comparison_Task.csv")

Ordering_Cards_Task <- read_csv("./Ordering_Cards_Task.csv")

Correlation_Score_Cards_Task <- read_delim("./Correlation_Score_Cards_Task.csv")
