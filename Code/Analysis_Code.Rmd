...
Ordering_Cards_Task <- read_csv("./Ordering_Cards_Task.csv") # Data Experiment 1 - Ordering Cards Task
Correlation_Score_Cards_Task <- read_delim("./Correlation_Score_Cards_Task.csv") # Data Experiment 1 - Ordering Cards Task (Distribution)


Numerosity_Comparison_Task <- read_csv("./Numerosity_Comparison_Task.csv") # Data Experiment 2 - Numerosity Comparison Task
...
```{r , echo=F, message=F, warning=FALSE,  fig.height=9, fig.width=12}
